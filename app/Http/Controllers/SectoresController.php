...
class SectoresController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumbs = [['link' => "home", 'name' => "Inicio"],['link' => "gestion", 'name' => "Gestión"],
                        ['link' => "", 'name' => "Sectores"]];
        return view('Sectores.component',['breadcrumbs'=>$breadcrumbs]);
    }
    ...
    public function actualizar(Request $request)
    {
        ...
        $registro = Sector::find($request->id);
    ...
    public function buscarRegistro(Request $request)
    {
        ...
        $registro = Sector::findOrFail($request['id']);
