...
use App\AccionCliente;

class ClientesAccionesController extends Controller
{
    //*******************************************************************************
    ...
    public function lista(Request $request)
    {
        ...
        $registros = AccionCliente::where('cliente_id',$request->id)->get();
    ...
    public function actualizar(Request $request)
    {
        ...
        $registro = AccionCliente::find($request->id);
        ...
        $registro->cerrada = $request->cerrada;
    ...
    public function buscarRegistro(Request $request)
    {
        ...
        $registro = AccionCliente::findOrFail($request['id']);
