...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        tabla = $('#tabla_formasPago').dataTable( {
            'destroy': true,
            'processing': true,
            'responsive': true,
            'autoWidth': false,
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        $('#tabla_formasPago tbody').on('click','.editar', function(){
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        $('#tabla_formasPago tbody').on('click','.eliminar', function(){
            //Obtenemos el id del registro
            let data = tabla.api().row($(this).parents()).data();
            swal({
    ...
    //*********************************************************/
    function editar(id){
            let url_ = "{{ route('formasPago.buscarRegistro') }}"
            $.ajax({
                data:  {"id":id},
                url: url_,
                type:  'get',
    ...
    function eliminar(id){
            let url_ = "{{ route('formasPago.eliminar') }}"
    ...
    function grabaRegistro(){
        ...
        let url;
        if ($('#id_').val()===''){
            url = "{{ route('formasPago.nuevo') }}"
        }
        else {
            url = "{{ route('formasPago.actualizar') }}"
        }
    ...
    function limpiaCampos(){
        $('#id_').val('');
        $('#titulo').html('Nueva forma de pago')
        $('#nombre').val('');
        $('#importe').val('');
