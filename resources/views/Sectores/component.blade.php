...
{{--                                <h3>Sectores</h3>--}}
                    ...
                    <div class="float-lg-right">
                        <button class="btn btn-primary mr-2" type="button" id="btn_add">Añadir sector</button>
                    </div>
                    <br>
                    <div class="table-responsive mb-4">
                        {{-- INICIO: TABLA --}}
                        <table id="tabla_sectores" class="tabla_datos table table-hover">
                            <thead class="bg-sgls">
                            <tr>
