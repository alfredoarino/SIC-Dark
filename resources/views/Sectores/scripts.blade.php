...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        tabla = $('#tabla_sectores').dataTable( {
            'destroy': true,
            'processing': true,
            'responsive': true,
            'autoWidth': false,
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        $('#tabla_sectores tbody').on('click','.editar', function(){
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        $('#tabla_sectores tbody').on('click','.eliminar', function(){
            //Obtenemos el id del registro
            let data = tabla.api().row($(this).parents()).data();
            swal({
    ...
    //*********************************************************/
    function editar(id){
            let url_ = "{{ route('sectores.buscarRegistro') }}"
            $.ajax({
                data:  {"id":id},
                url: url_,
                type:  'get',
    ...
    function eliminar(id){
            let url_ = "{{ route('sectores.eliminar') }}"
    ...
    function grabaRegistro(){
        ...
        let url;
        if ($('#id_').val()===''){
            url = "{{ route('sectores.nuevo') }}"
        }
        else {
            url = "{{ route('sectores.actualizar') }}"
        }
