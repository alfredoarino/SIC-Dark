...
{{--                                <h3>Pluses</h3>--}}
                    ...
                    <div class="float-lg-right">
                        <button class="btn btn-primary mr-2" type="button" id="btn_add">Añadir plus</button>
                    </div>
                    <br>
                    <div class="table-responsive mb-4">
                        {{-- INICIO: TABLA --}}
                        <table id="tabla_pluses" class="tabla_datos table table-hover">
                            <thead class="bg-sgls">
                            <tr>
