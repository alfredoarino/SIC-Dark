...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabla = $('#tabla_pagos').dataTable( {
            ...
            'columns': [
                ...
                {
                    data: 'incentivos', render: function (data) {
                        return (data==1?'Sí':'No');
                    }
                },
                {
        ...
        >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
        $('#tabla_pagos tbody').on('click','.editar', function(){
    ...
    //*********************************************************/
    function editar(id){
            let url_ = "{{ route('pagos.buscarRegistro') }}"
            $.ajax({
                data:  {"id":id},
                url: url_,
                type:  'get',
    ...
    function grabaRegistro(){
        ...
        let url;
        if ($('#id_').val()===''){
            url = "{{ route('pagos.nuevo') }}"
        }
        else {
            url = "{{ route('pagos.actualizar') }}"
        }
        ...
        data.append('incentivos',($('#incentivos').prop('checked')?1:0));
    ...
    function cargaDatos(response){
        ...
        $('#incentivos').prop('checked',(response['incentivos']==1 ? true : false));
