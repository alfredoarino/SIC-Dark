...
{{--                            <h3>Servicios</h3>--}}
                ...
                <div class="float-lg-right">
                    <button class="btn btn-primary mr-2" type="button" id="btn_add">Añadir servicio</button>
                </div>
                <br>
                <div class="table-responsive mb-4">
                    {{-- INICIO: TABLA --}}
                    <table id="tabla_servicios" class="tabla_datos table table-hover">
                        <thead class="bg-sgls">
                        <tr>
                            ...
                            <th class="text-center text-dark" style="text-transform: none">Cliente</th>
                            <th class="text-center text-dark" style="text-transform: none">Empresa</th>
